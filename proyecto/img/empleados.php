...
/* echo "no hay sesion, ni usuario en el url"; */
   ...
   //     echo("<script> window.location.href='empleados.php?ad=$uss&pagina=1' </script>");
    //}
    ...
    departamentos.id=empleados.Departamento inner join horario on horario.ID_departamento=departamentos.id
    inner join dia on dia.dia_id=horario.dia_id 
    where empleados.ID_empleado=:idE');
    ...
    $sentencia->execute(array(":idE" => $idE));
...
<body id="page-top" class="text-dark" class="p-2 bg-dark text-dark">
 ...
 <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active text-dark" href="#">Faltas</a>
        </li>
        <li class="nav-item">
...
<!-- ---------------------->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                  <!-- Aqui va el nombre de quien inicia sesion puede ser opcional -->
                                </span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3">
                        ...
                        <h1 class="col-sm-12 p-2 mb-1  text-dark" style="margin-left: 2%;">Empleados</h1>
                    </div>
  ...
  <div class="row justify-content-center">
    ...
    <table class="table table-responsive table-striped" style="color: white; background-color: rgb(72,61,139);">
        ...
        <tbody style="background-color: rgb(255,255,255); color:black;">
            ...
            <tr>
                <td> <?php echo $res->ID_empleado; ?></td>
                <td> <?php echo $res->nombre; ?> </td>
                <td> <?php echo $res->apellido; ?></td>
                <td> <?php echo $res->nom_departamento; ?> </td>
