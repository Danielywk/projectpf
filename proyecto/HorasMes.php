...
/* echo "no hay sesion, ni usuario en el url"; */
    ...
    if (!isset($_GET["pagina"])) {
        header("location:HorasMes.php?ad=$uss&pagina=1");
    }
    ...
    if ($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
        echo("<script> window.location.href='HorasMes.php?ad=$uss&pagina=1' </script>");
    }
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="p-2  text-dark">Registro de Horas-Mes</h1>
        ...
        <tbody style="background-color: rgb(255,255,255); color:black;">
            ...
            <tr>
                ...
                <td>
                  ...
                  <a href="php/reporte_M.php?id=<?php echo $dato->ID_empleado; ?>&dat=<?php echo $dato->fecha; ?>"
 ...
 ?>
    ...
    <nav>
            ...
            <ul class="pagination">
                ...
                <?php if ($pagina > 1) { ?>
                    <li>
                        <a class="page-link" href="./HorasMes.php?pagina=<?php echo $pagina - 1 ?>&ad=<?php echo $uss; ?>">
                ...
                <?php for ($x = 1; $x <= $paginas; $x++) { ?>
                    <li class="<?php if ($x == $pagina) echo 'active'; ?>">
                        <a style="color:black;" class="page-link" href="./HorasMes.php?pagina=<?php echo $x ?>&ad=<?php echo $uss; ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php } ?>
