...
/* echo "no hay sesion, ni usuario en el url"; */
    ...
    asistencia.ID_empleado=:id and DATE_FORMAT(asistencia.fecha, "%m")=DATE_FORMAT(NOW(), "%m");  ');
            ...
            <div id="content" style="background-color: white;">
                ...
                <h1 class="p-2  text-dark"></h1>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                        <a class="nav-link active text-dark" aria-current="page" href="RH_empleado.php?emp=<?php echo $uss ?>&id_e=<?php echo $idE ?>">Regresar</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link active text-dark" aria-current="page" href="HM_empleado.php?emp=<?php echo $uss ?>&id_e=<?php echo $idE ?>">Horas mes</a>
                        </li>
