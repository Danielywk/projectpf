...
/* echo "no hay sesion, ni usuario en el url"; */
    ...
    if (!isset($_GET["pagina"])) {
        header("location:HorasEmpleados.php?ad=$uss&pagina=1");
    }
    ...
    if ($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
        echo("<script> window.location.href='HorasEmpleados.php?ad=$uss&pagina=1' </script>");
    }

    $sentencia = $BD->prepare('SELECT empleados.ID_empleado, empleados.nombre, empleados.apellido, 
    asistencia.fecha,departamentos.nom_departamento, 
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="p-2  text-dark">Registro de Horas</h1>
    ...
    <table class="table table-responsive table-striped" style="color: white;">
        ...
        <tbody style="background-color: rgb(255,255,255); color:black;">
            ...
            <tr>
                ...
                <td> <?php echo $dato->H_entrada; ?> </td>
                <td> <?php echo $dato->H_salida; ?> </td>
 ...
 ?>
    ...
    <nav>
            ...
            <ul class="pagination">
                ...
                <?php if ($pagina > 1) { ?>
                    <li>
                        <a class="page-link" href="./HorasEmpleados.php?pagina=<?php echo $pagina - 1 ?>&ad=<?php echo $uss; ?>">
                ...
                <?php for ($x = 1; $x <= $paginas; $x++) { ?>
                    <li class="<?php if ($x == $pagina) echo 'active'; ?>">
                        <a style="color:black;" class="page-link" href="./HorasEmpleados.php?pagina=<?php echo $x ?>&ad=<?php echo $uss; ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php } ?>
