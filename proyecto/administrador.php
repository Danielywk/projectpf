...
/* echo "no hay sesion, ni usuario en el url"; */
    ...
    if (!isset($_GET["pagina"])) {
        header("location:administrador.php?ad=$uss&pagina=1");
    }
    ...
    if ($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
        echo("<script> window.location.href='administrador.php?ad=$uss&pagina=1' </script>");
    }

    $sentencia = $BD->prepare('SELECT empleados.ID_empleado, empleados.nombre, empleados.apellido, 
    departamentos.nom_departamento, dia.dia,
    concat(horario.H_entrada,"---",horario.H_salida) as "Horario" FROM empleados inner join departamentos on
    departamentos.id=empleados.Departamento inner join horario on horario.ID_departamento=departamentos.id
    inner join dia on dia.dia_id=horario.dia_id LIMIT :offset,:limit ');
...
<body id="page-top" class="text-dark" class="p-2 text-warning">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav  sidebar sidebar-dark accordion" style="background-color: rgb(0,0,128)" id="accordionSidebar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="background-color: white;">
                ...
                <h1 class="p-2  text-dark">Control de Empleados</h1>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                <ul class="navbar-nav me-auto mb-6 mb-lg-0">
                                    <li class="nav-item">
                                        <a class="nav-link active text-dark" aria-current="page" href="Alta_empleado.php?ad=<?php echo $uss; ?>">Alta empleado</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active text-dark" aria-current="page" href="baja_empleado.php?ad=<?php echo $uss; ?>">Baja empleado</a>
                                    </li>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xs-12 col-sm-6">
        <h1 style="margin-left:75%; color:black;">Empleados</h1>
 ...
 ?>
    ...
    <nav>
            ...
            <ul class="pagination">
                ...
                <?php if ($pagina > 1) { ?>
                    <li>
                        <a class="page-link" href="./administrador.php?pagina=<?php echo $pagina - 1 ?>&ad=<?php echo $uss; ?>">
                ...
                <?php for ($x = 1; $x <= $paginas; $x++) { ?>
                    <li class="<?php if ($x == $pagina) echo 'active'; ?>">
                        <a style="color:black;" class="page-link" href="./administrador.php?pagina=<?php echo $x ?>&ad=<?php echo $uss; ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php } ?>
