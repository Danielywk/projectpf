...
/* echo "no hay sesion, ni usuario en el url"; */
    ...
    if (!isset($_GET["pagina"])) {
        header("location:faltas.php?ad=$uss&pagina=1");
    }
    ...
    if ($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
        echo("<script> window.location.href='faltas.php?ad=$uss&pagina=1' </script>");
    }

    $sentencia = $BD->prepare('SELECT empleados.ID_empleado, empleados.nombre, empleados.apellido, asistencia.fecha,
    departamentos.nom_departamento, asistencia.faltas,
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="p-2  text-dark">Faltas</h1>
  ...
  <div class="row justify-content-center">
    <div class="col-auto mt-4">
        ...
        <div class="col-xs-12 col-sm-12">
         <h1 style="margin-left:10%; color:black;"> </h1>
 ...
 ?>
    ...
    <nav>
            ...
            <ul class="pagination">
                ...
                <?php if ($pagina > 1) { ?>
                    <li>
                        <a class="page-link" href="./faltas.php?pagina=<?php echo $pagina - 1 ?>&ad=<?php echo $uss; ?>">
                ...
                <?php for ($x = 1; $x <= $paginas; $x++) { ?>
                    <li class="<?php if ($x == $pagina) echo 'active'; ?>">
                        <a style="color:black;" class="page-link" href="./faltas.php?pagina=<?php echo $x ?>&ad=<?php echo $uss; ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php } ?>
